...
export default function CreateTaskPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // In real app, call create API here
      router.push("/tasks")
    } catch (error) {
        ...
        <div className="w-full space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              {/* <div>
                <h1 className="text-3xl font-bold text-slate-900">Tạo công việc mới</h1>
                <p className="text-slate-600 mt-1">Thêm công việc mới vào dự án</p>
              </div> */}
            </div>
          </div>
