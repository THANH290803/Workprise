                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] text-base border-slate-200 focus:border-blue-500 resize-none"
                      rows={5}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label className="text-base font-semibold">Dự án *</Label>
                      <Select
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {formData.tags.map((tag) => (
                      <Badge key={tag} variant="secondary" className="bg-blue-100 text-blue-700 px-3 py-1">
                        {tag}
                        <button type="button" onClick={() => handleRemoveTag(tag)} className="ml-2 hover:text-red-600">
                          <X className="h-3 w-3" />
                        </button>
                      </Badge>
                    ))}
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button type="button" onClick={handleAddTag} variant="outline" className="h-10 px-4">
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="estimatedHours" className="text-base font-semibold flex items-center gap-2">
